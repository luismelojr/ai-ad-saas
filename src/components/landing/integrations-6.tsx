        ...
        <div className="mx-auto max-w-5xl px-6">
          <div className="mx-auto max-w-md px-6 [mask-image:radial-gradient(ellipse_100%_100%_at_50%_0%,#000_70%,transparent_100%)]">
            <div className="bg-background dark:bg-muted/50 rounded-xl border px-6 pb-12 pt-3 shadow-xl">
              <Integration
                icon={<Gemini />}
                name="Gemini"
                description="Geração de texto natural e criativo."
              />
              <Integration
                icon={<Replit />}
                name="Replit"
                description="Infraestrutura otimizada para IA."
              />
              <Integration
                icon={<GooglePaLM />}
                name="GooglePaLM"
                description="Análise de dados avançada e insights."
              />
            </div>
          </div>
          <div className="mx-auto mt-6 max-w-lg space-y-6 text-center">
            <h2 className="text-balance text-3xl font-semibold md:text-4xl lg:text-5xl">
              Poder dos Melhores LLMs
            </h2>
            <p className="text-muted-foreground">
              Conectamos com os modelos mais avançados para garantir a qualidade
              dos seus anúncios.
            </p>
